...
const getSystemPrompt = (mode, tone, lang) => {
  ...
  const modeInstruction = {
    ...
    hooks: `You are an AI that generates ONE emotional tweet hook for a given topic. ${toneInstruction} ${langRules[lang]} CRITICAL: MAX 100 WORDS. Write 2-3 ultra-short emotional sentences. NO stories. NO fluff. One strong CTA. Reply with ONLY the hook text.`,
  }[mode]
